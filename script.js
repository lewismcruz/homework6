...
Borrowed code from another GitHub repository 
@ https://github.com/gabepettus/DayPlanner

But instead of simply copying and pasting the code,
I did rework the code to try to learn how it worked and
to refactor out unnecessary parts so I could learn how the
html, CSS, and JavaScript interworked.

==============================================================*/

// This makes code only run once DOM is ready for JavaScript to execute.
